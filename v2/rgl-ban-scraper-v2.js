...
const RGL_BAN_SITE = "https://rgl.gg/Public/PlayerBanList.aspx?r=40&r=40";
const BASE_RGL_URL = "https://rgl.gg/Public/PlayerProfile.aspx?p=";

const startingBan = "your starting ban steam id here";
...
async function getRglBans() {
	...
	if (startingBanIndex === -1) return console.log("Either there is >10 bans this interval, or steam id is not formatted correctly.");
